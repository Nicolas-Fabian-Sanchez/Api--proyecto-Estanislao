...
const pedidoMenu=async(req,res)=>{ // mando los datos de la mesa y envio el menu (para esto transformo los el array en dato json)
       const infoResivida = req.body;
       let ingresarMesa = await cargaMesa({mesa:infoResivida[0].mesa,pedido:infoResivida[0].pedido,totalPagar:infoResivida[0].totalPagar});
       console.log(infoResivida)//para ver la mesa recivida en consola ,no tiene funcion
